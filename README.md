...
[![CI](https://github.com/lucasilvestre1/dundie-rewards/actions/workflows/main.yml/badge.svg)](https://github.com/lucasilvestre1/dundie-rewards/actions/workflows/main.yml)
...
```py
dundie load assets/employee.csv
```
